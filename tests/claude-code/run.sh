...
case "$CMD" in
  ...
  marketplace)
    ...
    echo "  /plugin install agentlink-botcha-ai@agentlink-plugins"
    echo "  /plugin install agentlink-director@agentlink-plugins"
    echo "  /plugin install agentlink-artist@agentlink-plugins"
    echo ""
    mkdir -p "$WORK_DIR"
    cd "$WORK_DIR"
    exec claude
